...
SRC_URI = "file://rover-bridge/ \
           file://test_rover.py \
           file://test_bridge.py \
           file://test_bridge_interactive.py" \ ${bindir}/test_ultrasonic_rpi.py
...
do_install() {
    ...
    install -m 0755 ${WORKDIR}/test_bridge_interactive.py ${D}${bindir}/test_bridge_interactive.py \ ${bindir}/test_ultrasonic_rpi.py
    install -m 0755 ${WORKDIR}/test_ultrasonic_rpi.py ${D}${bindir}/test_ultrasonic_rpi.py
           file://test_ultrasonic_rpi.py
}

FILES:${PN} += "${PYTHON_SITEPACKAGES_DIR}/rover_bridge.so ${bindir}/test_rover.py ${bindir}/test_bridge.py ${bindir}/test_bridge_interactive.py" \ ${bindir}/test_ultrasonic_rpi.py
    install -m 0755 ${WORKDIR}/test_ultrasonic_rpi.py ${D}${bindir}/test_ultrasonic_rpi.py
           file://test_ultrasonic_rpi.py

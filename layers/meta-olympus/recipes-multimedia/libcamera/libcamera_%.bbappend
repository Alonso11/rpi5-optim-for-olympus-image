...
# meta-raspberrypi defines PACKAGECONFIG[raspberrypi] with only rpi/vc4 and
# appends it to PACKAGECONFIG for all rpi machines. PACKAGECONFIG flags are
# expanded into EXTRA_OECMAKE after any :append, so they always win.
# Override the entry here (meta-olympus has higher priority) to add pisp.
